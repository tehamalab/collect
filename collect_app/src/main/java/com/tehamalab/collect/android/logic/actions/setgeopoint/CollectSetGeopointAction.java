...
package com.tehamalab.collect.android.logic.actions.setgeopoint;
...
import com.tehamalab.collect.android.location.client.MaxAccuracyWithinTimeoutLocationClient;
...
public class CollectSetGeopointAction extends SetGeopointAction implements LocationListener {
    ...
    public void requestLocationUpdates() {
        ...
        if (GeneralSharedPreferences.getInstance().getBoolean(GeneralKeys.KEY_BACKGROUND_LOCATION, true)
