...
import static com.tehamalab.collect.android.logic.PropertyManager.PROPMGR_DEVICE_ID;
import static com.tehamalab.collect.android.logic.PropertyManager.PROPMGR_EMAIL;
import static com.tehamalab.collect.android.logic.PropertyManager.PROPMGR_PHONE_NUMBER;
import static com.tehamalab.collect.android.logic.PropertyManager.PROPMGR_SIM_SERIAL;
import static com.tehamalab.collect.android.logic.PropertyManager.PROPMGR_SUBSCRIBER_ID;
...
public class FormMetadataFragment extends BasePreferenceFragment {
    ...
    private void initNormalPrefs() {
        ...
        initPrefFromProp(pm, prefs, PROPMGR_USERNAME, GeneralKeys.KEY_METADATA_USERNAME);
        initPrefFromProp(pm, prefs, PROPMGR_EMAIL, GeneralKeys.KEY_METADATA_EMAIL);
    }

    private void initDangerousPrefs() {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(getActivity());
        PropertyManager pm = new PropertyManager(getActivity());
        initPrefFromProp(pm, prefs, PROPMGR_PHONE_NUMBER, GeneralKeys.KEY_METADATA_PHONENUMBER);
    ...
    private Preference.OnPreferenceChangeListener createChangeListener(final SharedPreferences sharedPreferences, final String key) {
        return (preference, newValue) -> {
            ...
            if (GeneralKeys.KEY_METADATA_EMAIL.equals(key)) {
