package com.tehamalab.collect.android.tasks.sms;
...
import com.tehamalab.collect.android.events.SmsRxEvent;
...
import com.tehamalab.collect.android.provider.InstanceProviderAPI;
...
import com.tehamalab.collect.android.tasks.sms.models.SmsProgress;
import com.tehamalab.collect.android.tasks.sms.models.SmsSubmission;
import com.tehamalab.collect.android.upload.InstanceServerUploader;
import com.tehamalab.collect.android.utilities.ArrayUtils;
import com.tehamalab.collect.android.utilities.FileUtil;
...
import com.tehamalab.collect.android.jobs.SmsSenderJob;
...
import static com.tehamalab.collect.android.tasks.sms.SmsSender.SMS_INSTANCE_ID;
import static com.tehamalab.collect.android.tasks.sms.SmsSender.SMS_MESSAGE_ID;
import static com.tehamalab.collect.android.tasks.sms.SmsSender.SMS_RESULT_CODE;
import static com.tehamalab.collect.android.tasks.sms.SmsSender.checkIfSentIntentExists;
...
public class SmsService {
    ...
    public boolean submitForm(String instanceId, FormInfo info, String displayName) {
        ...
        File smsFile = new File(FileUtil.getSmsInstancePath(info.getInstancePath()));
        ...
        try {
            text = FileUtil.getFileContents(smsFile);
        } catch (IOException e) {
