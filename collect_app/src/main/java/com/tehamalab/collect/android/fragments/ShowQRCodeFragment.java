...
package com.tehamalab.collect.android.fragments;
...
import com.tehamalab.collect.android.listeners.ActionListener;
...
import com.tehamalab.collect.android.preferences.AdminPreferencesActivity;
...
import com.tehamalab.collect.android.utilities.CompressionUtils;
...
import com.tehamalab.collect.android.utilities.QRCodeUtils;
...
public class ShowQRCodeFragment extends Fragment {
    ...
    private void updateShareIntent() {
        ...
        Uri uri =
                FileProvider.getUriForFile(getActivity(), BuildConfig.APPLICATION_ID + ".provider", new File(QRCodeUtils.QR_CODE_FILEPATH));
