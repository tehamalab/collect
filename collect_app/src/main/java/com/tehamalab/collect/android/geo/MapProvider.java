...
import com.tehamalab.collect.android.geo.MapboxMapConfigurator.MapboxUrlOption;
import com.tehamalab.collect.android.geo.OsmDroidMapConfigurator.WmsOption;
...
public class MapProvider {
    ...
    private static @NonNull SourceOption getOption(String id) {
        if (id == null) {
            id = PrefUtils.getSharedPrefs().getString(GeneralKeys.KEY_BASEMAP_SOURCE, null);
        }
