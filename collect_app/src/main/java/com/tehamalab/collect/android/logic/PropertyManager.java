...
public class PropertyManager implements IPropertyManager {
    ...
    public PropertyManager(Context context) {
        ...
        initUserDefined(prefs, GeneralKeys.KEY_METADATA_USERNAME,    PROPMGR_USERNAME,      SCHEME_USERNAME);
        initUserDefined(prefs, GeneralKeys.KEY_METADATA_PHONENUMBER, PROPMGR_PHONE_NUMBER,  SCHEME_TEL);
        initUserDefined(prefs, GeneralKeys.KEY_METADATA_EMAIL,       PROPMGR_EMAIL,         SCHEME_MAILTO);
    }
