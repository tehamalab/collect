...
package com.tehamalab.collect.android.application;
...
import com.tehamalab.collect.android.preferences.AutoSendPreferenceMigrator;
import com.tehamalab.collect.android.preferences.FormMetadataMigrator;
...
import com.tehamalab.collect.android.preferences.PrefMigrator;
...
import com.tehamalab.collect.android.jobs.CollectJobCreator;
...
import com.tehamalab.collect.android.utilities.LocaleHelper;
import com.tehamalab.collect.android.utilities.NotificationUtils;
import com.tehamalab.collect.android.utilities.PRNGFixes;
...
import static com.tehamalab.collect.android.logic.PropertyManager.PROPMGR_USERNAME;
import static com.tehamalab.collect.android.logic.PropertyManager.SCHEME_USERNAME;
import static com.tehamalab.collect.android.tasks.sms.SmsNotificationReceiver.SMS_NOTIFICATION_ACTION;
import static com.tehamalab.collect.android.tasks.sms.SmsSender.SMS_SEND_ACTION;
...
public class Collect extends Application {
     ...
     * and application version name: {@code Dalvik/<version> (platform info) com.tehamalab.collect.android/v<version>}.
     *
    ...
    */
    ...
    public void initializeJavaRosa() {
        ...
        if (mgr.getSingularProperty(PROPMGR_USERNAME) == null || mgr.getSingularProperty(PROPMGR_USERNAME).isEmpty()) {
            mgr.putProperty(PROPMGR_USERNAME, SCHEME_USERNAME, (String) GeneralSharedPreferences.getInstance().get(GeneralKeys.KEY_USERNAME));
        }
