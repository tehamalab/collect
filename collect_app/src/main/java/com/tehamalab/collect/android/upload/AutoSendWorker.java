...
package com.tehamalab.collect.android.upload;
...
import com.tehamalab.collect.android.dto.Form;
import com.tehamalab.collect.android.dto.Instance;
...
public class AutoSendWorker extends Worker {
        ...
        for (Instance instance : toUpload) {
            try {
                ...
                if (protocol.equals(getApplicationContext().getString(R.string.protocol_google_sheets))
                    ...
                    anyFailure = true;
                    resultMessagesByInstanceId.put(instance.getDatabaseId().toString(), InstanceUploaderUtils.SPREADSHEET_UPLOADED_TO_GOOGLE_DRIVE);
                    continue;
                }
    ...
    private void showUploadStatusNotification(boolean anyFailure, String message) {
        ...
        PendingIntent pendingNotify = PendingIntent.getActivity(Collect.getInstance(), ApplicationConstants.RequestCodes.FORMS_UPLOADED_NOTIFICATION,
