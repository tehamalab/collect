...
public class FormDownloadListAdapter extends ArrayAdapter {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        final String formIDAtPosition = formAtPosition.get(FormDownloadList.FORM_ID_KEY);

        holder.formTitle.setText(formAtPosition.get(FormDownloadList.FORMNAME));
        holder.formSubtitle.setText(formAtPosition.get(FormDownloadList.FORMID_DISPLAY));
