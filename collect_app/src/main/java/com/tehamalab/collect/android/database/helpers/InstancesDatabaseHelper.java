...
public class InstancesDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String[] COLUMN_NAMES_V5 = new String[] {_ID, InstanceProviderAPI.InstanceColumns.DISPLAY_NAME, InstanceProviderAPI.InstanceColumns.SUBMISSION_URI, InstanceProviderAPI.InstanceColumns.CAN_EDIT_WHEN_COMPLETE,
