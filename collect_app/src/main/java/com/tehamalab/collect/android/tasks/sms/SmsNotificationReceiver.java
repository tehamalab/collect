...
public class SmsNotificationReceiver extends BroadcastReceiver {
    public static final String SMS_NOTIFICATION_ACTION = "com.tehamalab.collect.android.COLLECT_SMS_NOTIFICATION_ACTION";
    private static final String SMS_NOTIFICATION_GROUP = "com.tehamalab.collect.android.COLLECT_SMS_NOTIFICATION_GROUP";
    ...
    private Notification buildNotification() {
        ...
        return new NotificationCompat.Builder(context, NotificationUtils.CHANNEL_ID)
