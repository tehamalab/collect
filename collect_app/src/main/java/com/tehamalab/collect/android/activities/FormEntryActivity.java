...
package com.tehamalab.collect.android.activities;
...
import com.tehamalab.collect.android.preferences.PreferencesActivity;
...
import com.tehamalab.collect.android.adapters.IconMenuListAdapter;
import com.tehamalab.collect.android.adapters.model.IconMenuItem;
import com.tehamalab.collect.android.dao.FormsDao;
import com.tehamalab.collect.android.dao.helpers.ContentResolverHelper;
import com.tehamalab.collect.android.dao.helpers.FormsDaoHelper;
import com.tehamalab.collect.android.dao.helpers.InstancesDaoHelper;
import com.tehamalab.collect.android.events.ReadPhoneStatePermissionRxEvent;
import com.tehamalab.collect.android.events.RxEventBus;
import com.tehamalab.collect.android.exception.JavaRosaException;
import com.tehamalab.collect.android.external.ExternalDataManager;
import com.tehamalab.collect.android.formentry.FormEntryViewModel;
import com.tehamalab.collect.android.formentry.backgroundlocation.BackgroundLocationHelper;
import com.tehamalab.collect.android.formentry.backgroundlocation.BackgroundLocationManager;
import com.tehamalab.collect.android.fragments.MediaLoadingFragment;
import com.tehamalab.collect.android.fragments.dialogs.CustomDatePickerDialog;
import com.tehamalab.collect.android.fragments.dialogs.FormLoadingDialogFragment;
import com.tehamalab.collect.android.fragments.dialogs.LocationProvidersDisabledDialog;
import com.tehamalab.collect.android.fragments.dialogs.NumberPickerDialog;
import com.tehamalab.collect.android.fragments.dialogs.ProgressDialogFragment;
import com.tehamalab.collect.android.fragments.dialogs.RankingWidgetDialog;
import com.tehamalab.collect.android.listeners.AdvanceToNextListener;
import com.tehamalab.collect.android.listeners.FormLoaderListener;
import com.tehamalab.collect.android.listeners.FormSavedListener;
import com.tehamalab.collect.android.listeners.PermissionListener;
import com.tehamalab.collect.android.listeners.SavePointListener;
import com.tehamalab.collect.android.listeners.WidgetValueChangedListener;
import com.tehamalab.collect.android.location.client.GoogleLocationClient;
...
import com.tehamalab.collect.android.logic.FormController.FailedConstraint;
import com.tehamalab.collect.android.logic.FormInfo;
import com.tehamalab.collect.android.logic.ImmutableDisplayableQuestion;
import com.tehamalab.collect.android.provider.FormsProviderAPI.FormsColumns;
import com.tehamalab.collect.android.provider.InstanceProviderAPI.InstanceColumns;
import com.tehamalab.collect.android.tasks.FormLoaderTask;
import com.tehamalab.collect.android.tasks.SaveFormIndexTask;
import com.tehamalab.collect.android.tasks.SavePointTask;
import com.tehamalab.collect.android.tasks.SaveResult;
import com.tehamalab.collect.android.tasks.SaveToDiskTask;
import com.tehamalab.collect.android.upload.AutoSendWorker;
import com.tehamalab.collect.android.utilities.ActivityAvailability;
import com.tehamalab.collect.android.utilities.ApplicationConstants;
import com.tehamalab.collect.android.utilities.DependencyProvider;
import com.tehamalab.collect.android.utilities.DialogUtils;
import com.tehamalab.collect.android.utilities.FileUtils;
import com.tehamalab.collect.android.utilities.ImageConverter;
import com.tehamalab.collect.android.utilities.MediaManager;
import com.tehamalab.collect.android.utilities.MediaUtils;
import com.tehamalab.collect.android.utilities.PermissionUtils;
import com.tehamalab.collect.android.utilities.RegexUtils;
import com.tehamalab.collect.android.utilities.SnackbarUtils;
import com.tehamalab.collect.android.utilities.SoftKeyboardUtils;
import com.tehamalab.collect.android.utilities.ToastUtils;
import com.tehamalab.collect.android.views.ODKView;
import com.tehamalab.collect.android.widgets.DateTimeWidget;
import com.tehamalab.collect.android.widgets.QuestionWidget;
import com.tehamalab.collect.android.widgets.RangeWidget;
import com.tehamalab.collect.android.widgets.StringWidget;
...
import static com.tehamalab.collect.android.utilities.ApplicationConstants.RequestCodes;
import static com.tehamalab.collect.android.utilities.PermissionUtils.areStoragePermissionsGranted;
import static com.tehamalab.collect.android.utilities.PermissionUtils.finishAllActivities;
