...
import com.tehamalab.collect.android.test.MockedServerTest;
...
import static com.tehamalab.collect.android.test.TestUtils.assertMatches;
import static com.tehamalab.collect.android.test.TestUtils.cleanUpTempFiles;
import static com.tehamalab.collect.android.test.TestUtils.createTempFile;
import static com.tehamalab.collect.android.test.TestUtils.resetInstancesContentProvider;
...
public class InstanceServerUploaderTaskTest extends MockedServerTest {
    ...
    public void shouldUploadAnInstance() throws Exception {
        ...
        HEAD: {
            ...
            assertMatches("Dalvik/.* com.tehamalab.collect.android/.*", r.getHeader("User-Agent"));
