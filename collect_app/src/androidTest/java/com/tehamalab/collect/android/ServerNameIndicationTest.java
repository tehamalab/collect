...
import com.tehamalab.collect.android.support.CollectHelpers;
...
public class ServerNameIndicationTest {
    ...
    public void testThatHttpClientSupportsSNI() throws Exception {
        OpenRosaHttpInterface openRosaHttpInterface = CollectHelpers.getAppDependencyComponent().openRosaHttpInterface();
